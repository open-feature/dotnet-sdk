...
[
  ![Release](https://img.shields.io/static/v1?label=release&message=v1.5.2&color=blue&style=for-the-badge) <!-- x-release-please-version -->
](https://github.com/open-feature/dotnet-sdk/releases/tag/v1.5.2) <!-- x-release-please-version -->
