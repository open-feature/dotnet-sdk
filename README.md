...
[
![Release](https://img.shields.io/static/v1?label=release&message=v2.7.1&color=blue&style=for-the-badge) <!-- x-release-please-version -->
](https://github.com/open-feature/dotnet-sdk/releases/tag/v2.7.1) <!-- x-release-please-version -->
